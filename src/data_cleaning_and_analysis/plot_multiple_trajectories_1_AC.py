...
for i, flight in df_ac.iterrows():
    ...
    legend_i = (
        "vol du " + date_map + " - " + flight.airport_departure + " --> " + flight.airport_arrival)
...
fig.update_layout(
    ...
    title_text=("<b>3 vols en 3 jours pour l'"
                + ac_proprio
                + "</b><br>"
                + registration_ac
                + " - "
...
fig.update_layout(
    ...
    legend_borderwidth=1,
    legend_bordercolor="grey",
    legend_title="Vol de la journée du " + date_map,
